  ...
  try {
    ...
    document.querySelector('.main-content').innerHTML = `
      ...
      <div id="aiChannelForm" style="display:none" class="card">
        ...
        <div class="form-group">
          <label class="form-label">Ne tur kanallar istiyorsunuz?</label>
          <textarea class="form-textarea" id="aiChannelPrompt" rows="3" placeholder="Ornek: Bir oyun sunucusu icin kanal yapisi olustur. Genel sohbet, duyurular, kurallar, sesli kanallar ve moderasyon kanallari olsun. Moderasyon kanallarina sadece yoneticiler erisebilsin."></textarea>
          <p class="form-hint">Detayli anlattiginizda AI daha iyi sonuc uretir. Kanal izinleri, kategoriler, konu aciklamalari belirtebilirsiniz.</p>
        </div>
        <div class="btn-group">
